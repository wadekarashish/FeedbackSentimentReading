...
namespace FeedbackReadingModel_ConsoleApp
{
    public partial class FeedbackReadingModel
    {
        public const string RetrainFilePath =  @"D:\Tests\Tests\FeedbackSentimentReading\FeedbackSentimentReading\yelp_labelled.txt";
